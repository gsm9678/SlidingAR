...
public class SerialController : MonoBehaviour
{
    ...
    IEnumerator SetSerial()
    {
        yield return new WaitUntil(() => GameManager.GetGameManager.GetReadData.GetCompleted);

        portName = GameManager.GetGameManager.GetReadData.GetCOM;
        baudRate = GameManager.GetGameManager.GetReadData.GetBaudRate;
    }

    private void start()
    {
        StartCoroutine(SetSerial());
    }
    // ------------------------------------------------------------------------
